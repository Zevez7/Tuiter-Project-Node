...
export default class FollowController implements FollowControllerI {
  ...
  public static getInstance = (app: Express): FollowController => {
    if (FollowController.followController === null) {
      ...
      app.delete(
        "/follow/userFollowed/:userFollowed/userFollowing/:userFollowing",
        FollowController.followController.deleteFollow
      );
      app.get(
        "/follow/followers/:uid",
        FollowController.followController.getFollowersOfAUser
      );
      app.get(
        "/follow/following/:uid",
        FollowController.followController.getFollowingOfAUser
      );
      app.delete(
        "/follow/following/:uid",
        FollowController.followController.removeAllPeopleWhoWereFollowingAUser
      );
      app.delete(
        "/follow/follower/:uid",
        FollowController.followController.removeAllPeopleWhoWereFollowedByAUser
      );
    }
  ...
  createFollow = (req: Request, res: Response) =>
    FollowController.followDao
      .createFollow(req.body)
      .then((follwer) => res.json(follwer));

  deleteFollow = (req: Request, res: Response) =>
    FollowController.followDao
      .deleteFollow(req.params.userFollowed, req.params.userFollowing)
      .then((status) => res.json(status));

  getFollowingOfAUser = (req: Request, res: Response) =>
    FollowController.followDao
      .getFollowingOfAUser(req.params.uid)
      .then((follwers) => res.json(follwers));

  getFollowersOfAUser = (req: Request, res: Response) =>
    FollowController.followDao
      .getFollowersOfAUser(req.params.uid)
      .then((follwers) => res.json(follwers));

  removeAllPeopleWhoWereFollowingAUser = (req: Request, res: Response) =>
    FollowController.followDao
      .removeAllPeopleWhoWereFollowingAUser(req.params.uid)
      .then((status) => res.json(status));

  removeAllPeopleWhoWereFollowedByAUser = (req: Request, res: Response) =>
    FollowController.followDao
      .removeAllPeopleWhoWereFollowedByAUser(req.params.uid)
      .then((status) => res.json(status));
}
