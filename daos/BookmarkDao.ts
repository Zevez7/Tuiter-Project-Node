...
export default class BookmarkDao implements BookmarkDaoI {
  ...
  async findTuitsBookmarkedByAUser(uid: string): Promise<any> {
  ...
  async findUsersThatBookmarkedATuid(tid: string): Promise<any> {
    ...
    return await BookmarkModel.find({ bookmarkedTuit: tid })
  ...
  async removeUsersWhoBookmarkedATuit(tid: string): Promise<any> {
